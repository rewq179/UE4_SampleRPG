...
AItem::AItem()
{
	...
	static ConstructorHelpers::FObjectFinder<UDataTable> DataTable(TEXT("DataTable'/Game/Item/ItemTable.ItemTable'"));
...
void AItem::BeginPlay()
{
	...
	if (ItemTable)
	{
		FItemTableRow* ItemTableRow = ItemTable->FindRow<FItemTableRow>(FName(*(FString::FormatAsNumber(ItemId))), FString(""));
		
		Desc = (*ItemTableRow).Description;
	}
